        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.tasks.items.update', [$task, $item]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4 p-4 border border-gray-300 rounded">
                            ...
                            @if(isset($item->content['matrix_image']))
                                <div class="mt-2 mb-3">
                                    ...
                                    <img src="{{ asset('storage/' . $item->content['matrix_image']) }}"
                                         alt="Matriz actual"
                        ...
                        <div class="mb-4 p-4 border border-gray-300 rounded">
                            ...
                            <p class="text-sm text-gray-500 mb-3">Gestiona las opciones de respuesta (máximo 8 opciones)</p>
