        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.tasks.items.spatial.store', $task) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="question_text" id="question_text" rows="3" required
                                      ...
                                      placeholder="Escribe aquí la instrucción o pregunta para el participante">{{ old('question_text') }}</textarea>
                        ...
                        <div class="mb-4 p-4 border border-gray-300 rounded">
                            ...
                            <input type="file" name="stimulus_image" id="stimulus_image" accept="image/*" required
                            ...
                            <p class="mt-1 text-sm text-gray-500">Sube la imagen de estímulo principal (SVG, PNG, JPG). Máx: 2MB</p>
                        ...
                        <div class="mb-4 p-4 border border-gray-300 rounded">
                            ...
                            <p class="text-sm text-gray-500 mb-3">Sube las imágenes de las opciones de respuesta (máximo 6 opciones)</p>
