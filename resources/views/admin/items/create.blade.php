                    ...
                    <form method="POST" action="{{ route('admin.items.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-4 p-4 border border-gray-300 rounded">
                                ...
                                <input type="file" name="matrix_image" id="matrix_image" required accept="image/*"
                                ...
                                <p class="mt-1 text-sm text-gray-500">Formatos: JPG, PNG, GIF, WEBP (Máx. 2MB)</p>
                                @error('matrix_image')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="mb-4 p-4 border border-gray-300 rounded">
                                ...
                                @endfor
                                <p class="mt-1 text-sm text-gray-500">Sube las imágenes de las opciones de respuesta (opcional para algunas opciones)</p>
                            </div>
                        </div>
